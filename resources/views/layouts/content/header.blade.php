<header class="navbar navbar-expand-md d-print-none">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="/dashboard">
                <img src="{{ asset('img/omahan-snack.svg') }}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
        </h1>
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    {{-- <img class="avatar avatar-sm" src="https://ui-avatars.com/api/?name={{ auth()->user()->profile->name ?? auth()->user()->name }}" class="rounded-circle"> --}}
                    <div class="d-none d-xl-block ps-2">
                        {{-- <div>{{ auth()->user()->profile->name ?? auth()->user()->name }}</div> --}}
